/**
 ...
 @Name: jcyNetCompany - 大气风格的网络公司企业模版
 @Author: xuxingyu
 @Copyright: jcy.com
 
 */

jcy.define(['jquery', 'element', 'carousel', 'laypage'], function(exports){
  var $ = jcy.jquery
  ,element = jcy.element
  ,carousel = jcy.carousel
  ,laypage = jcy.laypage;
  ...
  ,ul = $('.nav').find('.nav-list').children('.jcy-nav');
  ...
  $('.main-about').find('.aboutab').children('li').each(function(index){
    $(this).on('click', function(){
      $(this).addClass('jcy-this').siblings().removeClass('jcy-this');
